from cosmix.data.PolyChordLite.pypolychord.output import PolyChordOutput
...
def _setup_windows_dll_search_path():
    ...
    extra_dir = os.environ.get("POLYCHORD_DLL_DIR")
    if extra_dir:
        candidate_dirs.insert(0, Path(extra_dir))
    ...
    for dll_dir in candidate_dirs:
        if dll_dir.is_dir():
            try:
                ...
                # Ignore invalid or inaccessible DLL directories.
                pass


_setup_windows_dll_search_path()

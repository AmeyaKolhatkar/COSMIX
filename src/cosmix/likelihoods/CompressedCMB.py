...
from cosmix.core.ParameterManager_ import Parameter, GaussianPrior
from cosmix.Constants import c, Omegar0


_DATA_CompCMB = DATA_DIR / "Compressed_CMB" 
...
class CompressedCMB(LikelihoodBase):
    ...
    def __init__(self, pm, data_file=None, cov_file=None):
        ...
        self.d_vec = data["value"].values   # shape (4,)
    ...
    def lnlike(self, theta, theory):
        ...
        chi_star = np.trapezoid(c / H_chi, z_chi)     # [Mpc]
        ...
        H_rs  = H0 * E_rs
        rs_star = np.trapezoid(c_s / H_rs, z_rs)
    ...
    def get_theory_components(self, theta, theory, z_override=None):
        ...
        chi_star = np.trapezoid(c / H_chi, z_chi)

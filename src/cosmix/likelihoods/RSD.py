...
from cosmix.core.ParameterManager_ import Parameter, UniformPrior, GaussianPrior
from cosmix.theory.LCDM import LCDM
...
Default_data_file = DATA_DIR / "RSD" / "RSD-1.xlsx"
...
class RedshiftSpaceDistortion(LikelihoodBase):
    ...
    def data_manifest(self):
        ...
        """
        from cosmix.core.OverlapChecker import DataPoint
        data = pd.read_excel(self.data_file)
